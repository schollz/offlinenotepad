...
COPY web/index.html web/about.html web/blog.html web/contact.html web/public.html web/tsconfig.json web/tsconfig.app.json web/tsconfig.node.json web/vite.config.ts ./
